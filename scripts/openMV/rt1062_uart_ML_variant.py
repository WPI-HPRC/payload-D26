...
# Detection transmission (JSON lines to the flight computer)
MAX_BLOBS_TX = 12            # must match MAX_VISION_BLOBS on the flight computer
CONFIDENCE_SCALE = 1000      # density sent as an integer in thousandths (0-1000)
